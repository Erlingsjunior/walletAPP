// // ===== COMPONENTS/UI/CARDLIST/CARDLIST.STYLES.TS (JEITO RAIZ) =====
...
// export const GreenCardActive = styled.TouchableOpacity`
//     ${CardBase}
//     background-color: #10B981;
//     opacity: 1;
// `;

// export const GreenCardInactive = styled.TouchableOpacity`
//     ${CardBase}
//     background-color: #10B981;
//     opacity: 0.7;
// `;

// export const BlackCardActive = styled.TouchableOpacity`
//     ${CardBase}
//     background-color: #1a1a1a;
//     opacity: 1;
// `;

// export const BlackCardInactive = styled.TouchableOpacity`
//     ${CardBase}
//     background-color: #1a1a1a;
//     opacity: 0.7;
// `;
